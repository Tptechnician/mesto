...
const popupTitleViewImage = document.querySelector('.popup__title__viewimage');
const popupCloseViewImage = document.querySelector('.button__close-viewimage');
const profileEditButton = document.querySelector('.profile__edit-button');
const popup = document.querySelector('.popup');
const popupClose = document.querySelector('.popup__close');
const popupAddImage = document.querySelector('.addimage');
const popupCloseAddImage = document.querySelector('.button__close-add-image');
